...
function change_mode(theme){
    ...
    if(theme == null || theme == "light"){
        ...
        document.getElementById("head_tag").innerHTML=document.getElementById("head_tag").innerHTML.replace('<link rel="stylesheet" href="../assets/css/dark-mode.css">',"");
    }else{
        sessionStorage.toChange="light";
        sessionStorage.theme="dark";
        document.getElementById("toggle-switch").checked = true;
        document.getElementById("head_tag").innerHTML += '<link rel="stylesheet" href="../assets/css/dark-mode.css">';
    }
}
