			...
			<nav id="navbar" class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
				<div class="container-fluid d-flex flex-column p-0">
					<a class="navbar-brand d-flex justify-content-center align-items-center sidebar-brand m-0" href="#">
						<div class="sidebar-brand-icon"><img loading="lazy" class="logo" src="' . $startPath . '/assets/img/logo.png"></div>
					...
					<ul class="nav navbar-nav text-light" id="accordionSidebar">
						...
						<a class="nav-link" href="/members/mailer.php"><i class="fas fa-mail-bulk"></i><span>&nbsp;Bulk Mailer</span></a>
